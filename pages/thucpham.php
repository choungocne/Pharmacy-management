...
// Giả định $base_url được định nghĩa trong base.php (được include ở file gọi thucpham.php)
...
$error_message = empty($products) ? "Không tìm thấy sản phẩm nào trong danh mục (ID: 26-63)." : '';
